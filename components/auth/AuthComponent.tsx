...
import { LoginResponseDTO, ResponseDTO } from "@/models/responseDTO";
...
export default function AuthComponent() {
  ...
  const signUp = async (
    ...
    const res: ResponseDTO = await SignUp(userDto);
  ...
  const login = async (email: string, password: string) => {
    const res: LoginResponseDTO= await Login(email, password);
      ...
      {getView ? (
        <div className="w-full flex-col box-border p-[20px] gap-[20px] ">
          ...
          <div className=" flex flex-col w-full gap-[10px] items-center   box-border p-[10px] mt-[2rem]">
            ...
            <div className=" w-full flex flex-row mobile:flex-col gap-[2px]  justify-between">
              <div className=" w-full  flex-col gap-[5px] px-[10px]  flex box-border">
                <span className=" text-[#9C9C9C]">Password</span>
                <div className=" w-full  box-border p-[5px] bg-[#FAFAFA] rounded-[6px] h-[41px] border  flex flex-row justify-center items-center">
                  <input
                    type="password"
          ...
          <div className=" w-full mobile:gap-[5px] mobile:flex-col-reverse flex flex-row justify-between pt-[10px] items-center box-border px-[1.5rem]">
            <div className=" flex flex-col gap-[2px]">
              <a
                className=" text-[15px] text-[#51983C] font-medium cursor-pointer"
                onClick={() => {
                  SetView(false);
                }}
              >
            ...
            <ShimmerButton
              ...
              onClick={() => {
                signUp(getFname, getLname, getEmail, getPassword);
              }}
            >
        ...
        <div className="w-full flex-col box-border p-[20px] gap-[20px] ">
          ...
          <div className=" w-full flex  mobile:gap-[5px] mobile:flex-col-reverse flex-row justify-between pt-[10px] items-center box-border px-[1.5rem]">
            ...
            <ShimmerButton
              className="shadow-2xl mobile:w-full"
              onClick={() => {
                login(getLoginEmail, getLoginPassword);
              }}
            >
              <span className="whitespace-pre-wrap text-center text-sm font-medium leading-none tracking-tight text-white dark:from-white dark:to-slate-900/10 lg:text-lg">
                Login
